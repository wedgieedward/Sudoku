...
try:
      ...
      ###Sudoku Generator Module####################################################################################################################################
            ...
            ### Returns a Randomly selected number from the list of unused numbers (Numbers 1-9) to be inputted into the grid
            def Get_Number(self):
                  global locator
                  if locator:
                        print 'in Get_Number'
...
except:#If the current version of python is wrong or they do not have the correct modules.
