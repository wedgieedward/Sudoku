...
# If the Program encounters an error, it will stop and an error message
# will be displayed
try:
    ...
    # Appropriate error if file cannot be found, allows users to still use the
    # program however.
    except IOError:
        print (
            'High Scores File Could Not Be Located, Scores Cannot Be Saved\n')
    ...
    class Application():
        ...
        def __init__(self):
            ...
            self.Reset_Variables()
                                 # Sets all Variables Needed to their default
                                 # values
            ...
            # Under Frame Widgets
            self.Subtitle = Label(
                self.UnderFrame, text="Created By Edward Thomason")
            self.Subtitle.grid(row=0, column=0)
            self.Stitle = Label(
                self.UnderFrame, text="Final Build: Hartlip CoE Primary")
            ...
            # Must Be Even
            # Edit Appropriatly
            # This number is the total amount of numbers that are removed
            # depending on each difficulty
            self.Easy_Remove_Total = 44
            self.Med_Remove_Total = 50
            self.Hard_Remove_Total = 56
            # These numbers are the penalty depending on what difficulty they
            # used
            ...
            # The Number of hints people are allowed depending on their
            # difficulties
    ...
    #
        ...
        def Name_Entry_Window(self):
            ...
            self.Entry_Label = Label(
                self.GridFrame, text="Please Enter Your Name (John, Smith)")
            self.Entry_Label.grid(row=1, column=0)

            self.Entry_Box = Entry(
                self.GridFrame, textvariable=self.text_var)
            ...
            self.Update_Label = Label(
                self.GridFrame, textvariable=self.name_var, fg='red')
            self.Update_Label.grid(row=3, column=0, columnspan=2)

            self.Play_Button = Button(
                self.GridFrame, text="Continue", command=self.clear_Entry_Window)
            self.Restart_Button = Button(
                self.GridFrame, text='Re-Enter Name', command=self.redo_name)
    ...
    #
        ...
        def Difficulty_Window(self):
            ...
            self.Label_Difficulty = Label(
                self.GridFrame, text='Please Select Difficulty:')
            self.Label_Difficulty.grid(row=0, column=0)

            self.Diff_Button_Easy = Button(
                self.GridFrame, text='Easy Puzzle', command=self.easy_puzzle)
            self.Diff_Button_Easy.grid(
                row=1, column=0, columnspan=2, sticky=W)

            self.Diff_Button_Intermediate = Button(
                self.GridFrame, text='Intermediate Puzzle', command=self.med_puzzle)
            self.Diff_Button_Intermediate.grid(
                row=2, column=0, columnspan=2, sticky=W)

            self.Diff_Button_Hard = Button(
                self.GridFrame, text='Hard Puzzle', command=self.hard_puzzle)
            self.Diff_Button_Hard.grid(
    ...
    #
        ...
        def Sudoku_Window(self):
            ...
            self.button1 = Button(
                self.ButtonFrame, text='1', activebackground='yellow', background='black', fg='white', font=self.Edward_Font,
                width=self.Button_Width, height=self.Button_Height,
                command=self.Button_1_Press)
            self.button1.grid(column=0, row=1)
            self.button2 = Button(
                self.ButtonFrame, text='2', activebackground='yellow', background='black', fg='white', font=self.Edward_Font,
                width=self.Button_Width, height=self.Button_Height,
                command=self.Button_2_Press)
            self.button2.grid(column=0, row=2)
            self.button3 = Button(
                self.ButtonFrame, text='3', activebackground='yellow', background='black', fg='white', font=self.Edward_Font,
                width=self.Button_Width, height=self.Button_Height,
                command=self.Button_3_Press)
            self.button3.grid(column=0, row=3)
            self.button4 = Button(
                self.ButtonFrame, text='4', activebackground='yellow', background='black', fg='white', font=self.Edward_Font,
                width=self.Button_Width, height=self.Button_Height,
                command=self.Button_4_Press)
            self.button4.grid(column=0, row=5)
            self.button5 = Button(
                self.ButtonFrame, text='5', activebackground='yellow', background='black', fg='white', font=self.Edward_Font,
                width=self.Button_Width, height=self.Button_Height,
                command=self.Button_5_Press)
            self.button5.grid(column=0, row=6)
            self.button6 = Button(
                self.ButtonFrame, text='6', activebackground='yellow', background='black', fg='white', font=self.Edward_Font,
                width=self.Button_Width, height=self.Button_Height,
                command=self.Button_6_Press)
            self.button6.grid(column=0, row=7)
            self.button7 = Button(
                self.ButtonFrame, text='7', activebackground='yellow', background='black', fg='white', font=self.Edward_Font,
                width=self.Button_Width, height=self.Button_Height,
                command=self.Button_7_Press)
            self.button7.grid(column=0, row=9)
            self.button8 = Button(
                self.ButtonFrame, text='8', activebackground='yellow', background='black', fg='white', font=self.Edward_Font,
                width=self.Button_Width, height=self.Button_Height,
                command=self.Button_8_Press)
            self.button8.grid(column=0, row=10)
            self.button9 = Button(
                self.ButtonFrame, text='9', activebackground='yellow', background='black', fg='white', font=self.Edward_Font,
                width=self.Button_Width, height=self.Button_Height,
                command=self.Button_9_Press)
            self.button9.grid(column=0, row=11)
            self.button0 = Button(
                self.ButtonFrame, text='Clear', activebackground='yellow', background='black', fg='white', font=self.Edward_Font,
                width=self.Button_Width, height=self.Button_Height,
                command=self.Button_0_Press)
            self.button0.grid(column=1, row=1)

            self.Check_Button = Button(
                self.ButtonFrame, text='Check', activebackground='green', background='black', fg='white', font=self.Edward_Font, width=self.Button_Width, height=self.Button_Height,
                command=self.Check_Button_Press)
            self.Check_Button.grid(column=1, row=11)

            self.Hint_Button = Button(
                self.ButtonFrame, textvariable=self.Hint_Text, activebackground='green', background='black', fg='white',
                font=self.Edward_Font, width=self.Button_Width, height=self.Button_Height, command=self.Hint_Button_Press)
            self.Hint_Button.grid(column=1, row=9)

            self.Active_Buttons = [
                self.button0, self.button1, self.button2, self.button3, self.button4, self.button5,
                self.button6, self.button7, self.button8, self.button9, self.Hint_Button, self.Check_Button]
            # End Active Buttons###

            # Add Grid Buttons###
            #
            self.button_11 = Button(
                self.GridFrame, width=self.Button_Width, height=self.Button_Height,
                font=self.Edward_Font, textvariable=self.tv_11, text=self.tv_11, command=self.bp_11)
            self.button_11.grid(column=1, row=1)
            self.button_12 = Button(
                self.GridFrame, width=self.Button_Width, height=self.Button_Height,
                font=self.Edward_Font, textvariable=self.tv_12, text=self.tv_12, command=self.bp_12)
            self.button_12.grid(column=1, row=2)
            self.button_13 = Button(
                self.GridFrame, width=self.Button_Width, height=self.Button_Height,
                font=self.Edward_Font, textvariable=self.tv_13, text=self.tv_13, command=self.bp_13)
            self.button_13.grid(column=1, row=3)
            self.button_21 = Button(
                self.GridFrame, width=self.Button_Width, height=self.Button_Height,
                font=self.Edward_Font, textvariable=self.tv_21, text=self.tv_21, command=self.bp_21)
            self.button_21.grid(column=2, row=1)
            self.button_22 = Button(
                self.GridFrame, width=self.Button_Width, height=self.Button_Height,
                font=self.Edward_Font, textvariable=self.tv_22, text=self.tv_22, command=self.bp_22)
            self.button_22.grid(column=2, row=2)
            self.button_23 = Button(
                self.GridFrame, width=self.Button_Width, height=self.Button_Height,
                font=self.Edward_Font, textvariable=self.tv_23, text=self.tv_23, command=self.bp_23)
            self.button_23.grid(column=2, row=3)
            self.button_31 = Button(
                self.GridFrame, width=self.Button_Width, height=self.Button_Height,
                font=self.Edward_Font, textvariable=self.tv_31, text=self.tv_31, command=self.bp_31)
            self.button_31.grid(column=3, row=1)
            self.button_32 = Button(
                self.GridFrame, width=self.Button_Width, height=self.Button_Height,
                font=self.Edward_Font, textvariable=self.tv_32, text=self.tv_32, command=self.bp_32)
            self.button_32.grid(column=3, row=2)
            self.button_33 = Button(
                self.GridFrame, width=self.Button_Width, height=self.Button_Height,
                font=self.Edward_Font, textvariable=self.tv_33, text=self.tv_33, command=self.bp_33)
            self.button_33.grid(column=3, row=3)
            #
            self.button_14 = Button(
                self.GridFrame, width=self.Button_Width, height=self.Button_Height,
                font=self.Edward_Font, textvariable=self.tv_14, command=self.bp_14)
            self.button_14.grid(column=1, row=5)
            self.button_15 = Button(
                self.GridFrame, width=self.Button_Width, height=self.Button_Height,
                font=self.Edward_Font, textvariable=self.tv_15, command=self.bp_15)
            self.button_15.grid(column=1, row=6)
            self.button_16 = Button(
                self.GridFrame, width=self.Button_Width, height=self.Button_Height,
                font=self.Edward_Font, textvariable=self.tv_16, command=self.bp_16)
            self.button_16.grid(column=1, row=7)
            self.button_24 = Button(
                self.GridFrame, width=self.Button_Width, height=self.Button_Height,
                font=self.Edward_Font, textvariable=self.tv_24, command=self.bp_24)
            self.button_24.grid(column=2, row=5)
            self.button_25 = Button(
                self.GridFrame, width=self.Button_Width, height=self.Button_Height,
                font=self.Edward_Font, textvariable=self.tv_25, command=self.bp_25)
            self.button_25.grid(column=2, row=6)
            self.button_26 = Button(
                self.GridFrame, width=self.Button_Width, height=self.Button_Height,
                font=self.Edward_Font, textvariable=self.tv_26, command=self.bp_26)
            self.button_26.grid(column=2, row=7)
            self.button_34 = Button(
                self.GridFrame, width=self.Button_Width, height=self.Button_Height,
                font=self.Edward_Font, textvariable=self.tv_34, command=self.bp_34)
            self.button_34.grid(column=3, row=5)
            self.button_35 = Button(
                self.GridFrame, width=self.Button_Width, height=self.Button_Height,
                font=self.Edward_Font, textvariable=self.tv_35, command=self.bp_35)
            self.button_35.grid(column=3, row=6)
            self.button_36 = Button(
                self.GridFrame, width=self.Button_Width, height=self.Button_Height,
                font=self.Edward_Font, textvariable=self.tv_36, command=self.bp_36)
            self.button_36.grid(column=3, row=7)
            #
            self.button_17 = Button(
                self.GridFrame, width=self.Button_Width, height=self.Button_Height,
                font=self.Edward_Font, textvariable=self.tv_17, command=self.bp_17)
            self.button_17.grid(column=1, row=9)
            self.button_18 = Button(
                self.GridFrame, width=self.Button_Width, height=self.Button_Height,
                font=self.Edward_Font, textvariable=self.tv_18, command=self.bp_18)
            self.button_18.grid(column=1, row=10)
            self.button_19 = Button(
                self.GridFrame, width=self.Button_Width, height=self.Button_Height,
                font=self.Edward_Font, textvariable=self.tv_19, command=self.bp_19)
            self.button_19.grid(column=1, row=11)
            self.button_27 = Button(
                self.GridFrame, width=self.Button_Width, height=self.Button_Height,
                font=self.Edward_Font, textvariable=self.tv_27, command=self.bp_27)
            self.button_27.grid(column=2, row=9)
            self.button_28 = Button(
                self.GridFrame, width=self.Button_Width, height=self.Button_Height,
                font=self.Edward_Font, textvariable=self.tv_28, command=self.bp_28)
            self.button_28.grid(column=2, row=10)
            self.button_29 = Button(
                self.GridFrame, width=self.Button_Width, height=self.Button_Height,
                font=self.Edward_Font, textvariable=self.tv_29, command=self.bp_29)
            self.button_29.grid(column=2, row=11)
            self.button_37 = Button(
                self.GridFrame, width=self.Button_Width, height=self.Button_Height,
                font=self.Edward_Font, textvariable=self.tv_37, command=self.bp_37)
            self.button_37.grid(column=3, row=9)
            self.button_38 = Button(
                self.GridFrame, width=self.Button_Width, height=self.Button_Height,
                font=self.Edward_Font, textvariable=self.tv_38, command=self.bp_38)
            self.button_38.grid(column=3, row=10)
            self.button_39 = Button(
                self.GridFrame, width=self.Button_Width, height=self.Button_Height,
                font=self.Edward_Font, textvariable=self.tv_39, command=self.bp_39)
            self.button_39.grid(column=3, row=11)
            #
            self.button_41 = Button(
                self.GridFrame, width=self.Button_Width, height=self.Button_Height,
                font=self.Edward_Font, textvariable=self.tv_41, command=self.bp_41)
            self.button_41.grid(column=5, row=1)
            self.button_42 = Button(
                self.GridFrame, width=self.Button_Width, height=self.Button_Height,
                font=self.Edward_Font, textvariable=self.tv_42, command=self.bp_42)
            self.button_42.grid(column=5, row=2)
            self.button_43 = Button(
                self.GridFrame, width=self.Button_Width, height=self.Button_Height,
                font=self.Edward_Font, textvariable=self.tv_43, command=self.bp_43)
            self.button_43.grid(column=5, row=3)
            self.button_51 = Button(
                self.GridFrame, width=self.Button_Width, height=self.Button_Height,
                font=self.Edward_Font, textvariable=self.tv_51, command=self.bp_51)
            self.button_51.grid(column=6, row=1)
            self.button_52 = Button(
                self.GridFrame, width=self.Button_Width, height=self.Button_Height,
                font=self.Edward_Font, textvariable=self.tv_52, command=self.bp_52)
            self.button_52.grid(column=6, row=2)
            self.button_53 = Button(
                self.GridFrame, width=self.Button_Width, height=self.Button_Height,
                font=self.Edward_Font, textvariable=self.tv_53, command=self.bp_53)
            self.button_53.grid(column=6, row=3)
            self.button_61 = Button(
                self.GridFrame, width=self.Button_Width, height=self.Button_Height,
                font=self.Edward_Font, textvariable=self.tv_61, command=self.bp_61)
            self.button_61.grid(column=7, row=1)
            self.button_62 = Button(
                self.GridFrame, width=self.Button_Width, height=self.Button_Height,
                font=self.Edward_Font, textvariable=self.tv_62, command=self.bp_62)
            self.button_62.grid(column=7, row=2)
            self.button_63 = Button(
                self.GridFrame, width=self.Button_Width, height=self.Button_Height,
                font=self.Edward_Font, textvariable=self.tv_63, command=self.bp_63)
            self.button_63.grid(column=7, row=3)
            #
            self.button_44 = Button(
                self.GridFrame, width=self.Button_Width, height=self.Button_Height,
                font=self.Edward_Font, textvariable=self.tv_44, command=self.bp_44)
            self.button_44.grid(column=5, row=5)
            self.button_45 = Button(
                self.GridFrame, width=self.Button_Width, height=self.Button_Height,
                font=self.Edward_Font, textvariable=self.tv_45, command=self.bp_45)
            self.button_45.grid(column=5, row=6)
            self.button_46 = Button(
                self.GridFrame, width=self.Button_Width, height=self.Button_Height,
                font=self.Edward_Font, textvariable=self.tv_46, command=self.bp_46)
            self.button_46.grid(column=5, row=7)
            self.button_54 = Button(
                self.GridFrame, width=self.Button_Width, height=self.Button_Height,
                font=self.Edward_Font, textvariable=self.tv_54, command=self.bp_54)
            self.button_54.grid(column=6, row=5)
            self.button_55 = Button(
                self.GridFrame, width=self.Button_Width, height=self.Button_Height,
                font=self.Edward_Font, textvariable=self.tv_55, command=self.bp_55)
            self.button_55.grid(column=6, row=6)
            self.button_56 = Button(
                self.GridFrame, width=self.Button_Width, height=self.Button_Height,
                font=self.Edward_Font, textvariable=self.tv_56, command=self.bp_56)
            self.button_56.grid(column=6, row=7)
            self.button_64 = Button(
                self.GridFrame, width=self.Button_Width, height=self.Button_Height,
                font=self.Edward_Font, textvariable=self.tv_64, command=self.bp_64)
            self.button_64.grid(column=7, row=5)
            self.button_65 = Button(
                self.GridFrame, width=self.Button_Width, height=self.Button_Height,
                font=self.Edward_Font, textvariable=self.tv_65, command=self.bp_65)
            self.button_65.grid(column=7, row=6)
            self.button_66 = Button(
                self.GridFrame, width=self.Button_Width, height=self.Button_Height,
                font=self.Edward_Font, textvariable=self.tv_66, command=self.bp_66)
            self.button_66.grid(column=7, row=7)
            #
            self.button_47 = Button(
                self.GridFrame, width=self.Button_Width, height=self.Button_Height,
                font=self.Edward_Font, textvariable=self.tv_47, command=self.bp_47)
            self.button_47.grid(column=5, row=9)
            self.button_48 = Button(
                self.GridFrame, width=self.Button_Width, height=self.Button_Height,
                font=self.Edward_Font, textvariable=self.tv_48, command=self.bp_48)
            self.button_48.grid(column=5, row=10)
            self.button_49 = Button(
                self.GridFrame, width=self.Button_Width, height=self.Button_Height,
                font=self.Edward_Font, textvariable=self.tv_49, command=self.bp_49)
            self.button_49.grid(column=5, row=11)
            self.button_57 = Button(
                self.GridFrame, width=self.Button_Width, height=self.Button_Height,
                font=self.Edward_Font, textvariable=self.tv_57, command=self.bp_57)
            self.button_57.grid(column=6, row=9)
            self.button_58 = Button(
                self.GridFrame, width=self.Button_Width, height=self.Button_Height,
                font=self.Edward_Font, textvariable=self.tv_58, command=self.bp_58)
            self.button_58.grid(column=6, row=10)
            self.button_59 = Button(
                self.GridFrame, width=self.Button_Width, height=self.Button_Height,
                font=self.Edward_Font, textvariable=self.tv_59, command=self.bp_59)
            self.button_59.grid(column=6, row=11)
            self.button_67 = Button(
                self.GridFrame, width=self.Button_Width, height=self.Button_Height,
                font=self.Edward_Font, textvariable=self.tv_67, command=self.bp_67)
            self.button_67.grid(column=7, row=9)
            self.button_68 = Button(
                self.GridFrame, width=self.Button_Width, height=self.Button_Height,
                font=self.Edward_Font, textvariable=self.tv_68, command=self.bp_68)
            self.button_68.grid(column=7, row=10)
            self.button_69 = Button(
                self.GridFrame, width=self.Button_Width, height=self.Button_Height,
                font=self.Edward_Font, textvariable=self.tv_69, command=self.bp_69)
            self.button_69.grid(column=7, row=11)
            #
            self.button_71 = Button(
                self.GridFrame, width=self.Button_Width, height=self.Button_Height,
                font=self.Edward_Font, textvariable=self.tv_71, command=self.bp_71)
            self.button_71.grid(column=9, row=1)
            self.button_72 = Button(
                self.GridFrame, width=self.Button_Width, height=self.Button_Height,
                font=self.Edward_Font, textvariable=self.tv_72, command=self.bp_72)
            self.button_72.grid(column=9, row=2)
            self.button_73 = Button(
                self.GridFrame, width=self.Button_Width, height=self.Button_Height,
                font=self.Edward_Font, textvariable=self.tv_73, command=self.bp_73)
            self.button_73.grid(column=9, row=3)
            self.button_81 = Button(
                self.GridFrame, width=self.Button_Width, height=self.Button_Height,
                font=self.Edward_Font, textvariable=self.tv_81, command=self.bp_81)
            self.button_81.grid(column=10, row=1)
            self.button_82 = Button(
                self.GridFrame, width=self.Button_Width, height=self.Button_Height,
                font=self.Edward_Font, textvariable=self.tv_82, command=self.bp_82)
            self.button_82.grid(column=10, row=2)
            self.button_83 = Button(
                self.GridFrame, width=self.Button_Width, height=self.Button_Height,
                font=self.Edward_Font, textvariable=self.tv_83, command=self.bp_83)
            self.button_83.grid(column=10, row=3)
            self.button_91 = Button(
                self.GridFrame, width=self.Button_Width, height=self.Button_Height,
                font=self.Edward_Font, textvariable=self.tv_91, command=self.bp_91)
            self.button_91.grid(column=11, row=1)
            self.button_92 = Button(
                self.GridFrame, width=self.Button_Width, height=self.Button_Height,
                font=self.Edward_Font, textvariable=self.tv_92, command=self.bp_92)
            self.button_92.grid(column=11, row=2)
            self.button_93 = Button(
                self.GridFrame, width=self.Button_Width, height=self.Button_Height,
                font=self.Edward_Font, textvariable=self.tv_93, command=self.bp_93)
            self.button_93.grid(column=11, row=3)
            #
            self.button_74 = Button(
                self.GridFrame, width=self.Button_Width, height=self.Button_Height,
                font=self.Edward_Font, textvariable=self.tv_74, command=self.bp_74)
            self.button_74.grid(column=9, row=5)
            self.button_75 = Button(
                self.GridFrame, width=self.Button_Width, height=self.Button_Height,
                font=self.Edward_Font, textvariable=self.tv_75, command=self.bp_75)
            self.button_75.grid(column=9, row=6)
            self.button_76 = Button(
                self.GridFrame, width=self.Button_Width, height=self.Button_Height,
                font=self.Edward_Font, textvariable=self.tv_76, command=self.bp_76)
            self.button_76.grid(column=9, row=7)
            self.button_84 = Button(
                self.GridFrame, width=self.Button_Width, height=self.Button_Height,
                font=self.Edward_Font, textvariable=self.tv_84, command=self.bp_84)
            self.button_84.grid(column=10, row=5)
            self.button_85 = Button(
                self.GridFrame, width=self.Button_Width, height=self.Button_Height,
                font=self.Edward_Font, textvariable=self.tv_85, command=self.bp_85)
            self.button_85.grid(column=10, row=6)
            self.button_86 = Button(
                self.GridFrame, width=self.Button_Width, height=self.Button_Height,
                font=self.Edward_Font, textvariable=self.tv_86, command=self.bp_86)
            self.button_86.grid(column=10, row=7)
            self.button_94 = Button(
                self.GridFrame, width=self.Button_Width, height=self.Button_Height,
                font=self.Edward_Font, textvariable=self.tv_94, command=self.bp_94)
            self.button_94.grid(column=11, row=5)
            self.button_95 = Button(
                self.GridFrame, width=self.Button_Width, height=self.Button_Height,
                font=self.Edward_Font, textvariable=self.tv_95, command=self.bp_95)
            self.button_95.grid(column=11, row=6)
            self.button_96 = Button(
                self.GridFrame, width=self.Button_Width, height=self.Button_Height,
                font=self.Edward_Font, textvariable=self.tv_96, command=self.bp_96)
            self.button_96.grid(column=11, row=7)
            #
            self.button_77 = Button(
                self.GridFrame, width=self.Button_Width, height=self.Button_Height,
                font=self.Edward_Font, textvariable=self.tv_77, command=self.bp_77)
            self.button_77.grid(column=9, row=9)
            self.button_78 = Button(
                self.GridFrame, width=self.Button_Width, height=self.Button_Height,
                font=self.Edward_Font, textvariable=self.tv_78, command=self.bp_78)
            self.button_78.grid(column=9, row=10)
            self.button_79 = Button(
                self.GridFrame, width=self.Button_Width, height=self.Button_Height,
                font=self.Edward_Font, textvariable=self.tv_79, command=self.bp_79)
            self.button_79.grid(column=9, row=11)
            self.button_87 = Button(
                self.GridFrame, width=self.Button_Width, height=self.Button_Height,
                font=self.Edward_Font, textvariable=self.tv_87, command=self.bp_87)
            self.button_87.grid(column=10, row=9)
            self.button_88 = Button(
                self.GridFrame, width=self.Button_Width, height=self.Button_Height,
                font=self.Edward_Font, textvariable=self.tv_88, command=self.bp_88)
            self.button_88.grid(column=10, row=10)
            self.button_89 = Button(
                self.GridFrame, width=self.Button_Width, height=self.Button_Height,
                font=self.Edward_Font, textvariable=self.tv_89, command=self.bp_89)
            self.button_89.grid(column=10, row=11)
            self.button_97 = Button(
                self.GridFrame, width=self.Button_Width, height=self.Button_Height,
                font=self.Edward_Font, textvariable=self.tv_97, command=self.bp_97)
            self.button_97.grid(column=11, row=9)
            self.button_98 = Button(
                self.GridFrame, width=self.Button_Width, height=self.Button_Height,
                font=self.Edward_Font, textvariable=self.tv_98, command=self.bp_98)
            self.button_98.grid(column=11, row=10)
            self.button_99 = Button(
                self.GridFrame, width=self.Button_Width, height=self.Button_Height,
                font=self.Edward_Font, textvariable=self.tv_99, command=self.bp_99)
            self.button_99.grid(column=11, row=11)

            self.Buttons = [
                [self.button_11, self.button_12, self.button_13, self.button_14,
                    self.button_15, self.button_16, self.button_17, self.button_18, self.button_19],
                [self.button_21, self.button_22, self.button_23, self.button_24,
                            self.button_25, self.button_26, self.button_27, self.button_28, self.button_29],
                [self.button_31, self.button_32, self.button_33, self.button_34,
                            self.button_35, self.button_36, self.button_37, self.button_38, self.button_39],
                [self.button_41, self.button_42, self.button_43, self.button_44, self.button_45,
                            self.button_46, self.button_47, self.button_48, self.button_49],
                [self.button_51, self.button_52, self.button_53, self.button_54, self.button_55,
                            self.button_56, self.button_57, self.button_58, self.button_59],
                [self.button_61, self.button_62, self.button_63, self.button_64, self.button_65,
                            self.button_66, self.button_67, self.button_68, self.button_69],
                [self.button_71, self.button_72, self.button_73, self.button_74, self.button_75,
                            self.button_76, self.button_77, self.button_78, self.button_79],
                [self.button_81, self.button_82, self.button_83, self.button_84,
                            self.button_85, self.button_86, self.button_87, self.button_88, self.button_89],
            ...
            # to fix this use self.GridFrame.columnconfigure(columnnumber,
            # weight = value) and GridFrame.rowconfigure(rownumber, weight =
            # value)
            self.fill_1 = Button(
                self.GridFrame, width=0, height=0, borderwidth=0,)
        ...
        def update_cell(self, position):
            ...
            self.Buttons[x_pos][y_pos].config(
                background=self.Button_Background)
        ...
        # Changes the current active button to be sunken and 'un sinks' the
        # previously sunk button
        def Change_Sunken(self, button_number):
            ...
            self.Active_Buttons[button_number].config(
                bg=self.Active_Background_Colour)
        ...
        # If all 81 numbers check correctly againt their correct answer it runs
        # the End_Game() function
        ...
        def End_Game(self):
            ...
            self.Display_Time_Taken = Label(
                self.TopLevel, text=Time_Taken_Text)
            self.Label_Difficulty_Penalty = Label(
                self.TopLevel, text='Difficulty Penalty: ')
            self.Display_Difficulty_Penalty = Label(
                self.TopLevel, text=str(difficulty_penalty))
            self.Label_Hints_Used = Label(self.TopLevel, text='Hints Used: ')
            self.Display_Hints_Used = Label(
                self.TopLevel, text=str(self.Hints_Used))
            self.Label_Hint_Penalty = Label(
                self.TopLevel, text='Hint Penalty: ')
            self.Display_Hint_Penalty = Label(
                self.TopLevel, text=str(hint_penalty))
            self.Label_Checks_Used = Label(
                self.TopLevel, text='Incorrect Checks: ')
            self.Display_Checks_Used = Label(
                self.TopLevel, text=str(self.Checks_Used))
            self.Label_Check_Penalty = Label(
                self.TopLevel, text='Check Penalty: ')
            self.Display_Check_Penalty = Label(
                self.TopLevel, text=str(check_penalty))
            self.Label_Total_Penalty = Label(
                self.TopLevel, text='Total_Penalty: ')
            self.Display_Total_Penalty = Label(
                self.TopLevel, text=str(self.Time_Penalty))
            self.Label_Total_Time = Label(
                self.TopLevel, text='Total Score: ')
            self.Display_Total_Time = Label(
                self.TopLevel, text=str(total_time))
            ...
            try:
                ...
                tag = self.Player_Name + ',' + self.Difficulty_Used + ',' + \
                    str(int(tt)) + ',' + str(
                        self.Hints_Used) + ',' + str(total_time) + '\n'
                q.write(tag)
                q.close()
            ...
            self.Play_Again_Button = Button(
                self.GridFrame, text='Play Again?', command=self.PlayAgain)
        ...
        def Reset_Variables(self):
            ...
            self.Btn_Change_List = [
                [self.Btn_11_Change, self.Btn_12_Change, self.Btn_13_Change, self.Btn_14_Change,  self.Btn_15_Change,
                    self.Btn_16_Change,  self.Btn_17_Change,  self.Btn_18_Change,  self.Btn_19_Change],
                [self.Btn_21_Change,  self.Btn_22_Change,  self.Btn_23_Change,  self.Btn_24_Change,
                                self.Btn_25_Change,  self.Btn_26_Change,  self.Btn_27_Change,  self.Btn_28_Change,  self.Btn_29_Change],
                [self.Btn_31_Change,  self.Btn_32_Change,  self.Btn_33_Change,  self.Btn_34_Change,
                                self.Btn_35_Change,  self.Btn_36_Change,  self.Btn_37_Change,  self.Btn_38_Change,  self.Btn_39_Change],
                [self.Btn_41_Change,  self.Btn_42_Change,  self.Btn_43_Change,  self.Btn_44_Change,  self.Btn_45_Change,
                                self.Btn_46_Change,  self.Btn_47_Change,  self.Btn_48_Change,  self.Btn_49_Change],
                [self.Btn_51_Change,  self.Btn_52_Change,  self.Btn_53_Change,  self.Btn_54_Change,
                                self.Btn_55_Change,  self.Btn_56_Change,  self.Btn_57_Change,  self.Btn_58_Change,  self.Btn_59_Change],
                [self.Btn_61_Change,  self.Btn_62_Change,  self.Btn_63_Change,  self.Btn_64_Change,  self.Btn_65_Change,
                                self.Btn_66_Change,  self.Btn_67_Change,  self.Btn_68_Change,  self.Btn_69_Change],
                [self.Btn_71_Change,  self.Btn_72_Change,  self.Btn_73_Change,  self.Btn_74_Change,  self.Btn_75_Change,
                                self.Btn_76_Change,  self.Btn_77_Change,  self.Btn_78_Change,  self.Btn_79_Change],
                [self.Btn_81_Change,  self.Btn_82_Change,  self.Btn_83_Change,  self.Btn_84_Change,
                                self.Btn_85_Change,  self.Btn_86_Change,  self.Btn_87_Change,  self.Btn_88_Change,  self.Btn_89_Change],
            ...
            self.Button_Var = [
                [self.tv_11, self.tv_12, self.tv_13, self.tv_14, self.tv_15,
                             self.tv_16, self.tv_17, self.tv_18, self.tv_19],
                [self.tv_21, self.tv_22, self.tv_23, self.tv_24, self.tv_25,
                             self.tv_26, self.tv_27, self.tv_28, self.tv_29],
                [self.tv_31, self.tv_32, self.tv_33, self.tv_34,
                             self.tv_35, self.tv_36, self.tv_37, self.tv_38, self.tv_39],
                [self.tv_41, self.tv_42, self.tv_43, self.tv_44, self.tv_45,
                             self.tv_46, self.tv_47, self.tv_48, self.tv_49],
                [self.tv_51, self.tv_52, self.tv_53, self.tv_54, self.tv_55,
                             self.tv_56, self.tv_57, self.tv_58, self.tv_59],
                [self.tv_61, self.tv_62, self.tv_63, self.tv_64,
                             self.tv_65, self.tv_66, self.tv_67, self.tv_68, self.tv_69],
                [self.tv_71, self.tv_72, self.tv_73, self.tv_74,
                             self.tv_75, self.tv_76, self.tv_77, self.tv_78, self.tv_79],
                [self.tv_81, self.tv_82, self.tv_83, self.tv_84, self.tv_85,
                             self.tv_86, self.tv_87, self.tv_88, self.tv_89],
    ...
    # Sudoku Generator Module####################################################################################################################################
        # Converts A Full Sudoku into a easy Sudoku by removing a set amount of
        # numbers
        ...
        # Converts A Full Sudoku into a medium Sudoku by removing a set amount
        # of numbers
        def Create_Med(self):
            global locator
            import random
        ...
        # Converts A Full Sudoku into a hard Sudoku by removing a set amount of
        # numbers
        ...
        def Build(self):
            ...
            import random
            import time
            # Used in debug to test how long it took to create a complete
            # sudoku
            start_time = time.clock()
            temp_Counter = 0
            while self.Complete_Grid == False:  # While the grid is not complete
                self.Get_Avaliable_Cells()
                                         # Works out the locations of empty
                                         # cells
                if debug:
                    print self.Avaliable_Cells

                self.Current_Number = self.Get_Number(
                )  # Randomly gets a number to start inputting into the grid
                if debug:
...
# If the current version of python is wrong or they do not have the
# correct modules.
except:
    input(
        'This Program Is Not Compatible For Versions Of Python Other Than 2.6.1,\n Press Enter To Quit')
